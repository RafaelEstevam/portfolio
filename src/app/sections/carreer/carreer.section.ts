...
export class CarreerSection implements OnInit {
  ...
  loadCompanies(){  
    this.apollo.watchQuery({
      ...
      this.companies = data.companies.filter((item:Curriculum) => item.isGraduation === false).sort((a:any,b:any) => Number(b.startEndDate.isCurrent) - Number(a.startEndDate.isCurrent));
